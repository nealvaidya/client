...
goog.object.extend(proto, model_config_pb);
...
proto.inference.InferTensorContents.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    byteContentsList: msg.getByteContentsList_asB64()
  };
...
proto.inference.InferTensorContents.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getByteContentsList_asU8();
  if (f.length > 0) {
 ...
 */
proto.inference.InferTensorContents.prototype.getByteContentsList = function() {
...
/**
 * repeated bytes byte_contents = 8;
 * This is a type-conversion wrapper around `getByteContentsList()`
 * @return {!Array<string>}
 */
proto.inference.InferTensorContents.prototype.getByteContentsList_asB64 = function() {
  return /** @type {!Array<string>} */ (jspb.Message.bytesListAsB64(
      this.getByteContentsList()));
};
 ...
 */
proto.inference.InferTensorContents.prototype.getByteContentsList_asU8 = function() {
 ...
 * @return {!proto.inference.InferTensorContents} returns this
 */
proto.inference.InferTensorContents.prototype.setByteContentsList = function(value) {
 ...
 * @return {!proto.inference.InferTensorContents} returns this
 */
proto.inference.InferTensorContents.prototype.addByteContents = function(value, opt_index) {
 ...
 * @return {!proto.inference.InferTensorContents} returns this
 */
proto.inference.InferTensorContents.prototype.clearByteContentsList = function() {
  return this.setByteContentsList([]);
};
...
proto.inference.ModelConfigResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    config: (f = msg.getConfig()) && model_config_pb.ModelConfig.toObject(includeInstance, f)
  };
...
proto.inference.ModelConfigResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new model_config_pb.ModelConfig;
      reader.readMessage(value,model_config_pb.ModelConfig.deserializeBinaryFromReader);
      msg.setConfig(value);
      break;
    default:
      reader.skipField();
...
proto.inference.ModelConfigResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      model_config_pb.ModelConfig.serializeBinaryToWriter
    );
  }
};
...
proto.inference.ModelConfigResponse.prototype.getConfig = function() {
  return /** @type{?proto.inference.ModelConfig} */ (
    jspb.Message.getWrapperField(this, model_config_pb.ModelConfig, 1));
};
 ...
 * @const
 */
proto.inference.ModelRepositoryParameter.oneofGroups_ = [[1,2,3]];
